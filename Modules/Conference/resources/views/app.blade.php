...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <head>
    ...
    <meta property="og:image" content="{{ asset($ogImg ?? '/build/img/niogg-launch-conference-flyer.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ asset($ogImg ?? '/build/img/niogg-launch-conference-flyer.jpg') }}" />

    <link itemprop="url" href="{{ Request::fullUrl() }}"/>
    <meta itemprop="name" content="{{ config('app.name') }}"/>
    <meta itemprop="description" content="{{ $metaDesc ?? ''}}"/>
    <meta itemprop="image" content="{{ asset($ogImg ?? '/build/img/niogg-launch-conference-flyer.jpg') }}" />
