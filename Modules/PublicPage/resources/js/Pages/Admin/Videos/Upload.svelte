<script>
	...
	// Initialize upload on server (no file upload - just metadata)
	async function initializeUpload(uploadItem) {
		...
		formData.append('file_size', uploadItem.file.size.toString());
		formData.append('mime_type', uploadItem.file.type);
