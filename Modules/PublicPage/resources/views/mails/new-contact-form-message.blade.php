...
<head>
  <title> New Message from NIOGG Website </title>
  <!--[if !mso]><!-->
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:center;color:#9B9B9B;">New message received from your website contact form <br /></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="text-align:center;">
                          <img src="{{ asset('/build/img/niogg-logo.png') }}" alt="logo" style="height: 100px;">
                        </div>
                      </td>
                    </tr>
                  </tbody>
            ...
            <td style="direction:ltr;font-size:0px;padding:20px 20px 0 20px;text-align:center;">
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:0 40px 10px 40px;word-break:break-word;">
                        <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:30px;font-weight:300;line-height:40px;text-align:center;color:#a18802;">New Contact Message.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:0px;padding-top:10px;word-break:break-word;">
                        <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:16px;font-weight:500;line-height:24px;text-align:center;color:#000000;">Someone just sent you a message from the {{ config('app.alt_name') }} website contact form.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:50px 40px 40px 40px;word-break:break-word;">
                      ...
                      <tr>
                        <td align="left" style="font-size:0px;padding:0 40px;word-break:break-word;">
                          <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:24px;text-align:left;color:#000000;">
                            <span style="font-weight: 500;">Name:</span> {{ $msg->name }}
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td align="left" style="font-size:0px;padding:0 40px;word-break:break-word;">
                          <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:24px;text-align:left;color:#000000;">
                            <span style="font-weight: 500;">Email:</span> {{ $msg->email }}
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td align="left" style="font-size:0px;padding:0 0 60px 40px;word-break:break-word;">
                          <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:16px;font-weight:300;line-height:24px;text-align:left;color:#000000;">
                            <span style="font-weight: 500;">Phone:</span> {{ $msg->phone }}
                          </div>
                        </td>
                      </tr>
                      <tr>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Montserrat, Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:24px;text-align:center;color:#9B9B9B;"><a href="#" style="color: #9B9B9B;">Unsubscribe</a> from this newsletter<br />No 28, Effurun-Sapele Road, Opposite Unity Bank, Warri, <br /> Delta State, Nigeria <br /> <a href="https://mjml.io" style="color: #9B9B9B; text-decoration:none;">Designed with mjml.io</a></div>
                      </td>
                    </tr>
                  </tbody>
                </table>
