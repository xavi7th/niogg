      ...
      <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
          ...
          <div class="flex justify-between h-16">
            ...
            <div class="flex">
              ...
              <div class="shrink-0 flex items-center">
                <Link href={window.route("appuser.dashboard")}>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
              ...
              <div class="ms-3 relative">
                <Dropdown align="right" width="48">
                  ...
                  <template id="content">
                    <DropdownLink href={window.route("profile.edit")}>Profile</DropdownLink>
            ...
            <div class="-me-2 flex items-center sm:hidden">
              <button on:click={() => (showingNavigationDropdown = !showingNavigationDropdown)} class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
        ...
        <div class:block={showingNavigationDropdown} class:hidden={!showingNavigationDropdown} class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink href={window.route("appuser.dashboard")} active={window.route().current("appuser.dashboard")}>Dashboard</ResponsiveNavLink>
          </div>
          ...
          <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
              ...
              <ResponsiveNavLink :href="window.route('logout')" method="post" as="button">Log Out</ResponsiveNavLink>
            </div>
          </div>
        </div>
      </nav>
