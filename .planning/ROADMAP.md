...
- [ ] **Phase 1: Fix Thumbnail Display** - Restore thumbnail images across all video views
...
Plans:
- [ ] 01-01: Fix accessor naming (format_duration vs formatDuration)
- [ ] 01-02: Replace direct img tags with LazyThumbnail component
- [ ] 01-03: Verify thumbnail paths and storage URLs
...
|-------|----------------|--------|-----------|
| 1. Fix Thumbnail Display | 0/3 | Not started | - |
