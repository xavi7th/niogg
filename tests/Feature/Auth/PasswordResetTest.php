...
class PasswordResetTest extends TestCase
{
  ...
  public function test_password_can_be_reset_with_valid_token(): void
  {
    ...
    Notification::assertSentTo($user, SendPasswordResetNotification::class, function ($notification) use ($user) {
      ...
      $response->assertSessionHasNoErrors()->assertRedirect(route('auth.login'));
